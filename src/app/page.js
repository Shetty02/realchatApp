      ...
      <div className="space-y-20 pb-20">
        ...
        <section className="relative text-center pt-16 pb-12 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto flex flex-col items-center">
          ...
          {user ? (
            ...
            <Link
              href="/chat"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-[12px] bg-blue-50 border border-blue-100 text-xs font-bold text-blue-600 backdrop-blur-sm mb-8 hover:bg-blue-100 hover:border-blue-200 transition-all hover:scale-105"
            >
              <Sparkles className="w-3.5 h-3.5 text-blue-500 animate-pulse" />
              <span>Log In to Get Started &rarr;</span>
            </Link>
          )}
